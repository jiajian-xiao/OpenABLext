...
struct Visitor {
  ...
  virtual void enter(ArrayCreationExpression &) {};
  ...
  virtual void enter(ConflictResolutionStatement &) {};
  ...
  virtual void leave(ArrayCreationExpression &) {};
  ...
  virtual void leave(ConflictResolutionStatement &) {};
