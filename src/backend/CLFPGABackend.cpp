...
void CLFPGABackend::generate(AST::Script &script, const BackendContext &ctx) {
  ...
  CLHFPGAPrinter printer(script, useFloat, ctx.withConflict);
  printer.print(script);
  writeToFile(ctx.outputDir + "/main.cpp", printer.extractStr());
  ...
  CLFPGAPrinter printerCL(script, useFloat, ctx.withConflict);
