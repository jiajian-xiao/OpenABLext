...
void ArrayCreationExpression::accept(Visitor &visitor) {
  visitor.enter(*this);
  elemType->accept(visitor);
  VISIT_EXPR(sizeExpr);
  visitor.leave(*this);
...
void ConflictResolutionStatement::accept(Visitor &visitor) {
  visitor.enter(*this);
  visitor.leave(*this);
}
...
void ArrayCreationExpression::print(Printer &printer) const { printer.print(*this); }
...
void ConflictResolutionStatement::print(Printer &printer) const { printer.print(*this); }
