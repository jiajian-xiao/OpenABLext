...
int main() {
    ...
    cl_command_queue command_queues[1];
    ...
    cl_kernel kernel_Point_0s[1];
    cl_kernel kernel_Point_1s[1];
    cl_kernel st_kernel_Points[1];
    cl_kernel mem_kernel_Points[1];
    cl_mem _var4MemObj_Points[1];
    cl_mem _var4MemObjDbuf_Points[1];
    cl_mem _var4MemObjLen_Points[1];
    cl_mem _var4MemObjEnv_Points[1];
    int activeDevice[1]={1};
    cl_mem _var4MemObjRng_Points[1];
    cl_mem _var4MemObjConflictFlag_Points[1];
    cl_kernel cr_kernel_Points[1];
    ...
    fclose(fp);
    for (int deviceIter = 0 ; deviceIter < 1 ; deviceIter++){
