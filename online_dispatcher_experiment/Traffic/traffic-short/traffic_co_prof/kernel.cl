...
void car_follow(__global Point *buff_Point, __global int *len_Point, __global Lane *roads,  __global uint2 *rngState, int agentIId, __global int *interaction_current, __global bool *isProfilingIter, Point* in, Point*out) {
...
void lane_change(__global Point *buff_Point, __global int *len_Point, __global Lane *roads,  __global uint2 *rngState, int agentIId, __global int *interaction_current, __global bool *isProfilingIter, Point* in, Point*out) {
    if (in->isFinished) return;
...
__kernel void compute_kernel_0_Point_0(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global Lane *roads_Point,  __global uint2 *rngState_Point, __global int *interaction_current, __global bool *isProfilingIter) {
    int _var19 = get_global_id(0);
    if (_var19 >= *len_Point) return;
    Point _var20 = buff_Point[_var19];
    Point _var21 = _var20;
    car_follow(buff_Point, len_Point, roads_Point, rngState_Point, _var19, interaction_current, isProfilingIter, &_var20, &_var21);
    if (!*isProfilingIter) {
        buff_Point[_var19] = _var21;
        dbuff_Point[_var19] = _var20;
    }
}
__kernel void compute_kernel_0_Point_1(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global Lane *roads_Point,  __global uint2 *rngState_Point, __global int *interaction_current, __global bool *isProfilingIter) {
    int _var16 = get_global_id(0);
    if (_var16 >= *len_Point) return;
    Point _var17 = buff_Point[_var16];
    Point _var18 = _var17;
    lane_change(buff_Point, len_Point, roads_Point, rngState_Point, _var16, interaction_current, isProfilingIter, &_var17, &_var18);
    if (!*isProfilingIter) {
        buff_Point[_var16] = _var18;
    } 
}
__kernel void compute_kernel_1_Point_0(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global Lane *roads_Point,  __global uint2 *rngState_Point, __global int *interaction_current, __global bool *isProfilingIter) {
    int _var19 = get_global_id(0);
    if (_var19 >= *len_Point) return;
    Point _var20 = buff_Point[_var19];
    Point _var21 = _var20;
...
__kernel void compute_kernel_1_Point_1(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global Lane *roads_Point,  __global uint2 *rngState_Point, __global int *interaction_current, __global bool *isProfilingIter) {
    int _var16 = get_global_id(0);
    if (_var16 >= *len_Point) return;
    Point _var17 = buff_Point[_var16];
    Point _var18 = _var17;
...
__kernel void mem_update_Point(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global Lane *roads_Point, __global bool *isConflicted_Point, __global int *interaction_current0, __global int *interaction_current1) {
    int i = get_global_id(0);
