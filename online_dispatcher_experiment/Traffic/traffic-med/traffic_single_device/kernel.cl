...
__kernel void compute_kernel_0_Point_1(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global Lane *roads_Point,  __global uint2 *rngState_Point) {
