...
int main() {
    ...
    cl_mem _var4MemObjRedo_0s[2];
    cl_mem _var4MemObjInteractionCurrent_0s[2];
    cl_mem _var4MemObjInteractionLast_0s[2];

    cl_mem _var4MemObjRedo_1s[2];
    cl_mem _var4MemObjInteractionCurrent_1s[2];
    cl_mem _var4MemObjInteractionLast_1s[2];

    cl_mem _var4MemObjIsProfilingIter_0s[2];
    cl_mem _var4MemObjIsProfilingIter_1s[2];

    cl_kernel interaction_rate_kernel_0s[2];
    cl_kernel interaction_rate_kernel_1s[2];
    ...
    for (int deviceIter = 0 ; deviceIter < 2 ; deviceIter++){
        ...
        cl_mem _var4MemObjRedo_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var4MemObjRedo_0s[deviceIter] = _var4MemObjRedo_0;
        cl_mem _var4MemObjRedo_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var4MemObjRedo_1s[deviceIter] = _var4MemObjRedo_1;
  
        cl_mem _var4MemObjIsProfilingIter_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var4MemObjIsProfilingIter_0s[deviceIter] = _var4MemObjIsProfilingIter_0;
        cl_mem _var4MemObjIsProfilingIter_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var4MemObjIsProfilingIter_1s[deviceIter] = _var4MemObjIsProfilingIter_1;

        cl_mem _var4MemObjInteractionCurrent_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var4MemObjInteractionCurrent_0s[deviceIter] = _var4MemObjInteractionCurrent_0;
        cl_mem _var4MemObjInteractionCurrent_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var4MemObjInteractionCurrent_1s[deviceIter] = _var4MemObjInteractionCurrent_1;

        cl_mem _var4MemObjInteractionLast_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var4MemObjInteractionLast_0s[deviceIter] = _var4MemObjInteractionLast_0;
        cl_mem _var4MemObjInteractionLast_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var4MemObjInteractionLast_1s[deviceIter] = _var4MemObjInteractionLast_1;
        ...
        cl_kernel interaction_rate_kernel_0 = clCreateKernel(program, "check_interaction_rate_0", &ret);
        interaction_rate_kernel_0s[deviceIter] = interaction_rate_kernel_0;

        cl_kernel interaction_rate_kernel_1 = clCreateKernel(program, "check_interaction_rate_1", &ret);
        interaction_rate_kernel_1s[deviceIter] = interaction_rate_kernel_1;
        ...
        ret |= clSetKernelArg(kernel_Point_0, 5, sizeof(cl_mem), &_var4MemObjInteractionCurrent_0);
        ret |= clSetKernelArg(kernel_Point_0, 6, sizeof(cl_mem), &_var4MemObjIsProfilingIter_0);
        ...
        ret |= clSetKernelArg(kernel_Point_1, 5, sizeof(cl_mem), &_var4MemObjInteractionCurrent_1);
        ret |= clSetKernelArg(kernel_Point_1, 6, sizeof(cl_mem), &_var4MemObjIsProfilingIter_1);
        ...
        ret |= clSetKernelArg(mem_kernel_Point, 5, sizeof(cl_mem), &_var4MemObjInteractionCurrent_0);
        ret |= clSetKernelArg(mem_kernel_Point, 6, sizeof(cl_mem), &_var4MemObjInteractionCurrent_1);
        ...
        ret = clSetKernelArg(interaction_rate_kernel_0, 0, sizeof(cl_mem), &_var4MemObjInteractionCurrent_0);
        ret |= clSetKernelArg(interaction_rate_kernel_0, 1, sizeof(cl_mem), &_var4MemObjInteractionLast_0);
        ret |= clSetKernelArg(interaction_rate_kernel_0, 2, sizeof(cl_mem), &_var4MemObjRedo_0);

        ret = clSetKernelArg(interaction_rate_kernel_1, 0, sizeof(cl_mem), &_var4MemObjInteractionCurrent_1);
        ret |= clSetKernelArg(interaction_rate_kernel_1, 1, sizeof(cl_mem), &_var4MemObjInteractionLast_1);
        ret |= clSetKernelArg(interaction_rate_kernel_1, 2, sizeof(cl_mem), &_var4MemObjRedo_1);
        ...
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjInteractionCurrent_0, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjInteractionLast_0, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjRedo_0, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjInteractionCurrent_1, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjInteractionLast_1, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjRedo_1, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);

        // bool tmp1 = true;
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjIsProfilingIter_0, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var4MemObjIsProfilingIter_1, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);
    }
    ...
    Point* _var7dbuff_Point0 = calloc(sizeof(Point), agents.agents_Point.len);
    Point* _var7dbuff_Point1 = calloc(sizeof(Point), agents.agents_Point.len);
    ...
    ret = clEnqueueWriteBuffer(command_queues[0], _var4MemObjIsProfilingIter_0s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_0s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[0], _var4MemObjInteractionCurrent_0s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjInteractionCurrent_0s[1], CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
   
    double stime = omp_get_wtime();
    for (int _var8 = 0; _var8 < PROFILING_ITERATION; _var8++) {
    ...
    clEnqueueNDRangeKernel(command_queues[0], interaction_rate_kernel_0s[0], 1, NULL,
                           &stglobalWorkSize, &stlocalWorkSize, 0,
                           NULL, NULL);
    clEnqueueNDRangeKernel(command_queues[1], interaction_rate_kernel_0s[1], 1, NULL,
                           &stglobalWorkSize, &stlocalWorkSize, 0,
                           NULL, NULL);
    ...
    if (gtime <= ( ctime - 0.001) ) {
        printf("run step function 0 on GPU\n");
        device_0 = 0;
        undevice_0 = 1;
    } else {
        printf("run step function 0 on CPU\n");
        device_0 = 1;
        undevice_0 = 0;
    }

    ret  = clEnqueueWriteBuffer(command_queues[0], _var4MemObjIsProfilingIter_1s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_1s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[0], _var4MemObjInteractionCurrent_1s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjInteractionCurrent_1s[1], CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
   
    stime = omp_get_wtime();
    for (int _var8 = 0; _var8 < PROFILING_ITERATION; _var8++) {
        ret = clEnqueueNDRangeKernel(command_queues[0], kernel_Point_1s[0], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
        ret = clEnqueueNDRangeKernel(command_queues[1], kernel_Point_1s[1], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
    }

    clEnqueueNDRangeKernel(command_queues[0], interaction_rate_kernel_1s[0], 1, NULL,
                           &stglobalWorkSize, &stlocalWorkSize, 0,
                           NULL, NULL);
    clEnqueueNDRangeKernel(command_queues[1], interaction_rate_kernel_1s[1], 1, NULL,
                           &stglobalWorkSize, &stlocalWorkSize, 0,
                           NULL, NULL);

    clFinish(command_queues[0]);
    gtime = omp_get_wtime() - stime;
    printf("GPU finishes %f seconds\n",gtime);

    clFinish(command_queues[1]);
    ctime = omp_get_wtime() - stime;
    printf("CPU finishes %f seconds\n",ctime);
    ...
    if (gtime <= ( ctime - 0.001) ) {
        printf("run step function 1 on GPU\n");
        device_1 = 0;
        undevice_1 = 1;
    } else {
        printf("run step function 1 on CPU\n");
        device_1 = 1;
        undevice_1 = 0;
    }
    ...
    ret |= clEnqueueWriteBuffer(command_queues[0], _var4MemObjIsProfilingIter_1s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_0s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_1s[1], CL_TRUE , 0, sizeof(bool), &tmp1, 0, NULL, NULL);

    bool redoProfiling0 = false;
    bool redoProfiling1 = false;

    int profilingStart0 = -1;
    int profilingEnd0 = -1;
    int profilingStart1 = -1;
    int profilingEnd1 = -1;

    bool interactionProfilePhase = false;
    int interactionProfilePhaseEnd = -1;

    double stime0 ;
    double stime1 ;

    for (int _var8 = 1; _var8 < num_timesteps+1+(num_timesteps/PROFILING_INTERVAL)*PROFILING_ITERATION+40; _var8++) {
        if (_var8 % PROFILING_INTERVAL == 0) {
            tmp0 = 0;
            tmp1 = true;
            ret  = clEnqueueWriteBuffer(command_queues[0], _var4MemObjIsProfilingIter_0s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_0s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
            ...
            ret |= clEnqueueWriteBuffer(command_queues[0], _var4MemObjInteractionCurrent_0s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjInteractionCurrent_0s[1], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[0], _var4MemObjInteractionCurrent_1s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[1], _var4MemObjInteractionCurrent_1s[1], CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);

            interactionProfilePhaseEnd = _var8+PROFILING_ITERATION;
            interactionProfilePhase = true;
        }

        if (interactionProfilePhase && _var8 == interactionProfilePhaseEnd){
            clEnqueueNDRangeKernel(command_queues[device_0], interaction_rate_kernel_0s[device_0], 1, NULL,
                                   &stglobalWorkSize, &stlocalWorkSize, 0,
                                   NULL, NULL);
            clEnqueueNDRangeKernel(command_queues[device_1], interaction_rate_kernel_1s[device_1], 1, NULL,
                                   &stglobalWorkSize, &stlocalWorkSize, 0,
                                   NULL, NULL);
            clFinish(command_queues[device_0]);
            clFinish(command_queues[device_1]);

            ret = clEnqueueReadBuffer(command_queues[device_0], _var4MemObjRedo_0s[device_0], CL_TRUE, 0, sizeof(bool),
                                      &redoProfiling0, 0, NULL, NULL);
            ret = clEnqueueReadBuffer(command_queues[device_1], _var4MemObjRedo_1s[device_1], CL_TRUE, 0, sizeof(bool),
                                      &redoProfiling1, 0, NULL, NULL);
        
            if (redoProfiling0) {
                profilingStart0 = _var8;
                profilingEnd0 = _var8+PROFILING_ITERATION;
                printf("Request to redo profiling for stepfunc 0 at iter %d for %d %d\n",_var8,profilingStart0,profilingEnd0);

                stime0 = omp_get_wtime();
            } else {
                tmp1 = false;
                ret = clEnqueueWriteBuffer(command_queues[0], _var4MemObjIsProfilingIter_0s[0], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
                ret = clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_0s[1], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
            }

            if (redoProfiling1) {
                profilingStart1 = _var8;
                profilingEnd1 = _var8+PROFILING_ITERATION;
                printf("Request to redo profiling for stepfunc 1 at iter %d for %d %d\n",_var8,profilingStart1,profilingEnd1);

                stime1 = omp_get_wtime();
            } else {
                tmp1 = false;
                ret = clEnqueueWriteBuffer(command_queues[0], _var4MemObjIsProfilingIter_1s[0], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
                ret = clEnqueueWriteBuffer(command_queues[1], _var4MemObjIsProfilingIter_1s[1], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
            }
            interactionProfilePhaseEnd = -1;
            interactionProfilePhase = false;
        }
        if (redoProfiling0 && _var8 < profilingEnd0) {
            ret = clEnqueueNDRangeKernel(command_queues[0], kernel_Point_0s[0], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            ret = clEnqueueNDRangeKernel(command_queues[1], kernel_Point_0s[1], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            if (!redoProfiling1) {
                continue;
        ...
        if (redoProfiling1 && _var8 < profilingEnd1) {
            ret = clEnqueueNDRangeKernel(command_queues[0], kernel_Point_1s[0], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            ret = clEnqueueNDRangeKernel(command_queues[1], kernel_Point_1s[1], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            continue;
        }

        if (_var8 == profilingEnd0) {
            clFinish(command_queues[0]);
            double gtime = omp_get_wtime() - stime0;
            printf("GPU finishes %f seconds\n",gtime);

            clFinish(command_queues[1]);
            double ctime = omp_get_wtime() - stime0;
            printf("CPU finishes %f seconds\n",ctime);
        ...
        if (_var8 == profilingEnd1) {
            clFinish(command_queues[0]);
            double gtime = omp_get_wtime() - stime1;
            printf("GPU finishes %f seconds\n",gtime);

            clFinish(command_queues[1]);
            double ctime = omp_get_wtime() - stime1;
            printf("CPU finishes %f seconds\n",ctime);
        ...
        ret  = clEnqueueNDRangeKernel(command_queues[device_0], kernel_Point_0s[device_0], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
        ret |= clEnqueueNDRangeKernel(command_queues[device_1], kernel_Point_1s[device_1], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
        clFinish(command_queues[device_1]);
        clFinish(command_queues[device_0]);

        clEnqueueReadBuffer(command_queues[device_0], _var4MemObj_Points[device_0], CL_TRUE, 0, _var4_Point, _var7buff_Point0, 0, NULL, NULL);
        clEnqueueReadBuffer(command_queues[device_1], _var4MemObj_Points[device_1], CL_TRUE, 0, _var4_Point, _var7buff_Point1, 0, NULL, NULL);
        ...
        if (device_0!=0) {
            clEnqueueReadBuffer(command_queues[device_0], _var4MemObjDbuf_Points[device_0], CL_TRUE, 0, _var4_Point, _var7dbuff_Point0, 0, NULL, NULL);
            clEnqueueWriteBuffer(command_queues[0], _var4MemObjDbuf_Points[0], CL_TRUE, 0, _var4_Point, _var7dbuff_Point0, 0, NULL, NULL);
        }
        do {
