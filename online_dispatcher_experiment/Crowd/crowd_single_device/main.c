...
int main() {
    ...
    cl_kernel upenv_kernel_Points[1];
    cl_mem _var6MemObj_Points[1];
    cl_mem _var6MemObjDbuf_Points[1];
    cl_mem _var6MemObjLen_Points[1];
    cl_mem _var6MemObjEnv_Points[1];
    int activeDevice[1]={1};
    cl_mem _var6MemObjRng_Points[1];
