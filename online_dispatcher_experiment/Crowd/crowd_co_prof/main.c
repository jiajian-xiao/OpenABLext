...
Point* coexecution_merge_Point(Point* A0, Point* A1) {
    if ((A1->id == A1->leader)) A1->target = A0->target;
    return A1;
}
int main() {
    ...
    cl_mem _var6MemObjRedo_0s[2];
    cl_mem _var6MemObjInteractionCurrent_0s[2];
    cl_mem _var6MemObjInteractionLast_0s[2];

    cl_mem _var6MemObjRedo_1s[2];
    cl_mem _var6MemObjInteractionCurrent_1s[2];
    cl_mem _var6MemObjInteractionLast_1s[2];

    cl_mem _var6MemObjIsProfilingIter_0s[2];
    cl_mem _var6MemObjIsProfilingIter_1s[2];
    ...
    for (int deviceIter = 0 ; deviceIter < 2 ; deviceIter++){
        ...
        cl_mem _var6MemObjRedo_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var6MemObjRedo_0s[deviceIter] = _var6MemObjRedo_0;
        cl_mem _var6MemObjRedo_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var6MemObjRedo_1s[deviceIter] = _var6MemObjRedo_1;
  
        cl_mem _var6MemObjIsProfilingIter_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var6MemObjIsProfilingIter_0s[deviceIter] = _var6MemObjIsProfilingIter_0;
        cl_mem _var6MemObjIsProfilingIter_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(bool), NULL , &ret);
        _var6MemObjIsProfilingIter_1s[deviceIter] = _var6MemObjIsProfilingIter_1;

        cl_mem _var6MemObjInteractionCurrent_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var6MemObjInteractionCurrent_0s[deviceIter] = _var6MemObjInteractionCurrent_0;
        cl_mem _var6MemObjInteractionCurrent_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var6MemObjInteractionCurrent_1s[deviceIter] = _var6MemObjInteractionCurrent_1;

        cl_mem _var6MemObjInteractionLast_0 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var6MemObjInteractionLast_0s[deviceIter] = _var6MemObjInteractionLast_0;
        cl_mem _var6MemObjInteractionLast_1 = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int), NULL , &ret);
        _var6MemObjInteractionLast_1s[deviceIter] = _var6MemObjInteractionLast_1;
        ...
        ret |= clSetKernelArg(kernel_Point_0, 5, sizeof(cl_mem), &_var6MemObjInteractionCurrent_0);
        ret |= clSetKernelArg(kernel_Point_0, 6, sizeof(cl_mem), &_var6MemObjIsProfilingIter_0);
        ...
        ret |= clSetKernelArg(kernel_Point_1, 5, sizeof(cl_mem), &_var6MemObjInteractionCurrent_1);
        ret |= clSetKernelArg(kernel_Point_1, 6, sizeof(cl_mem), &_var6MemObjIsProfilingIter_1);
        ...
        ret = clSetKernelArg(interaction_rate_kernel_0, 0, sizeof(cl_mem), &_var6MemObjInteractionCurrent_0);
        ret |= clSetKernelArg(interaction_rate_kernel_0, 1, sizeof(cl_mem), &_var6MemObjInteractionLast_0);
        ret |= clSetKernelArg(interaction_rate_kernel_0, 2, sizeof(cl_mem), &_var6MemObjRedo_0);

        ret = clSetKernelArg(interaction_rate_kernel_1, 0, sizeof(cl_mem), &_var6MemObjInteractionCurrent_1);
        ret |= clSetKernelArg(interaction_rate_kernel_1, 1, sizeof(cl_mem), &_var6MemObjInteractionLast_1);
        ret |= clSetKernelArg(interaction_rate_kernel_1, 2, sizeof(cl_mem), &_var6MemObjRedo_1);
        ...
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjInteractionCurrent_0, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjInteractionLast_0, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjRedo_0, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjInteractionCurrent_1, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjInteractionLast_1, CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjRedo_1, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);

        // bool tmp1 = 1;
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjIsProfilingIter_0, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, _var6MemObjIsProfilingIter_1, CL_TRUE, 0, sizeof(bool), &tmp0, 0, NULL, NULL);
    }
    ...
    ret = clEnqueueWriteBuffer(command_queues[0], _var6MemObjIsProfilingIter_0s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjIsProfilingIter_0s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[0], _var6MemObjInteractionCurrent_0s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjInteractionCurrent_0s[1], CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
   
    double stime = omp_get_wtime();
    for (int _var10 = 0; _var10 < PROFILING_ITERATION; _var10++) {
    ...
    ret  = clEnqueueWriteBuffer(command_queues[0], _var6MemObjIsProfilingIter_1s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjIsProfilingIter_1s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[0], _var6MemObjInteractionCurrent_1s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjInteractionCurrent_1s[1], CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
    ...
    tmp1 = false;
    ret  = clEnqueueWriteBuffer(command_queues[0], _var6MemObjIsProfilingIter_0s[0], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[0], _var6MemObjIsProfilingIter_1s[0], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjIsProfilingIter_0s[1], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjIsProfilingIter_1s[1], CL_TRUE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
    ...
    for (int _var10 = 0; _var10 < num_timesteps; _var10++) {
        if (_var10 % PROFILING_INTERVAL == 0) {
            tmp0 = 0;
            tmp1 = true;
            ret  = clEnqueueWriteBuffer(command_queues[0], _var6MemObjIsProfilingIter_0s[0], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjIsProfilingIter_0s[1], CL_FALSE, 0, sizeof(bool), &tmp1, 0, NULL, NULL);
            ...
            ret |= clEnqueueWriteBuffer(command_queues[0], _var6MemObjInteractionCurrent_0s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjInteractionCurrent_0s[1], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[0], _var6MemObjInteractionCurrent_1s[0], CL_FALSE, 0, sizeof(int), &tmp0, 0, NULL, NULL);
            ret |= clEnqueueWriteBuffer(command_queues[1], _var6MemObjInteractionCurrent_1s[1], CL_TRUE, 0, sizeof(int), &tmp0, 0, NULL, NULL);

            interactionProfilePhaseEnd = _var10+PROFILING_ITERATION;
            interactionProfilePhase = true;
        }

        if (interactionProfilePhase && _var10 == interactionProfilePhaseEnd){
            ...
            ret = clEnqueueReadBuffer(command_queues[device_0], _var6MemObjRedo_0s[device_0], CL_TRUE, 0, sizeof(bool),
                                      &redoProfiling0, 0, NULL, NULL);
            ret = clEnqueueReadBuffer(command_queues[device_1], _var6MemObjRedo_1s[device_1], CL_TRUE, 0, sizeof(bool),
                                      &redoProfiling1, 0, NULL, NULL);
        
            if (redoProfiling0) {
                profilingStart0 = _var10;
                profilingEnd0 = _var10+PROFILING_ITERATION;
                printf("Request to redo profiling for stepfunc 0 at iter %d for %d %d\n",_var10,profilingStart0,profilingEnd0);
            ...
            if (redoProfiling1) {
                profilingStart1 = _var10;
                profilingEnd1 = _var10+PROFILING_ITERATION;
                printf("Request to redo profiling for stepfunc 1 at iter %d for %d %d\n",_var10,profilingStart1,profilingEnd1);
            ...
            //else
           //     printf("No redo profiling for stepfunc 1 continue on %d\n",device_1);
        }
        // printf("%d %d %d\n", redoProfiling0,_var8,profilingEnd0);
        if (redoProfiling0 && _var10 < profilingEnd0) {
            // printf("Func 0 profiling %d\n",_var8);
            ret = clEnqueueNDRangeKernel(command_queues[0], kernel_Point_0s[0], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            ret = clEnqueueNDRangeKernel(command_queues[1], kernel_Point_0s[1], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            if (!redoProfiling1) {
                continue;
        ...
        // printf("%d %d %d\n", redoProfiling1,_var8,profilingEnd1);
        if (redoProfiling1 && _var10 < profilingEnd1) {
            // printf("Func 1 profiling %d\n",_var8);
            ret  = clEnqueueNDRangeKernel(command_queues[0], kernel_Point_1s[0], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            ret |= clEnqueueNDRangeKernel(command_queues[1], kernel_Point_1s[1], 1, NULL, &globalWorkSize_Point, &localWorkSize, 0, NULL, NULL);
            continue;
        }

        if (_var10 == profilingEnd0) {
            clFinish(command_queues[0]);
        ...
        clEnqueueReadBuffer(command_queues[device_1], _var6MemObj_Points[device_1], CL_TRUE, 0, _var6_Point, _var9buff_Point1, 0, NULL, NULL);
        clEnqueueReadBuffer(command_queues[device_0], _var6MemObj_Points[device_0], CL_TRUE, 0, _var6_Point, _var9buff_Point0, 0, NULL, NULL);
