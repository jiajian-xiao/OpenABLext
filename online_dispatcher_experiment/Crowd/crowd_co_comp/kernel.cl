...
void compute_leader_route(__global Point *buff_Point, __global int *len_Point, __global env *envo_Point,  __global uint2 *rngState, int agentIId, Point* in, Point*out) {
...
void move_all_point(__global Point *buff_Point, __global int *len_Point, __global env *envo_Point,  __global uint2 *rngState, int agentIId, Point* in, Point*out) {
...
__kernel void compute_kernel_0_Point_0(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global env *envo_Point,  __global uint2 *rngState_Point) {
    int _var21 = get_global_id(0);
    if (_var21 >= *len_Point) return;
    Point _var22 = buff_Point[_var21];
    Point _var23 = _var22;
    move_all_point(buff_Point, len_Point, envo_Point, rngState_Point, _var21, &_var22, &_var23);
    buff_Point[_var21] = _var23;
    dbuff_Point[_var21] = _var22;
}
__kernel void compute_kernel_1_Point_0(__global Point *buff_Point, __global Point *dbuff_Point, __global int *len_Point, __global env *envo_Point,  __global uint2 *rngState_Point) {
    int _var24 = get_global_id(0);
    if (_var24 >= *len_Point) return;
    Point _var25 = buff_Point[_var24];
    Point _var26 = _var25;
    compute_leader_route(buff_Point, len_Point, envo_Point, rngState_Point, _var24, &_var25, &_var26);
